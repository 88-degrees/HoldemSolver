...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_BoardSelectorTableDelegate_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_BoardSelectorTableDelegate_t qt_meta_stringdata_BoardSelectorTableDelegate = {
    {
QT_MOC_LITERAL(0, 26) // "BoardSelectorTableDelegate"
...
const QMetaObject BoardSelectorTableDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<WordItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_BoardSelectorTableDelegate.offsetsAndSize,
    qt_meta_data_BoardSelectorTableDelegate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_BoardSelectorTableDelegate_t
, QtPrivate::TypeAndForceComplete<BoardSelectorTableDelegate, std::true_type>
